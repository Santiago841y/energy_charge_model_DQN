function [NextObs,Reward,IsDone,LoggedSignals] = myStepFunction9(Action,LoggedSignals)
        ...
        for jj=1:rows
            if Break==0
                ...
                elseif chrate(jj)>0  && active_ev(jj)==0 % not correct
                    ...
                    Reward1=(0.2*sum(r0)+0.8*r5(jj))/jj;
                    n_jj=jj;
                    Break=1;
    ...
    if Break~=0
        ...
        elseif Break==3
           ...
           Penalty=Reward; 
            ...
            Reward=0.2*(0.25*r0t+0.25*r1t+0.25*r4t+0.25*r6t)+0.8*Penalty
